            ...
            <Container>
                <div className='about-page'>
                    <div className='our-container '>
                        ...
                        <AwesomeButton style={{"--button-primary-color": "#ff5e86", "--button-primary-color-dark": "#ff5e86", "--button-primary-color-hover": "#ff5e86", "--button-primary-color-active":"#ff5e86"}} className='custom-button' type="primary" _login={this.props._login} onPress={(e) => this.handleSignUpPress(e)}>Sign Up</AwesomeButton>
